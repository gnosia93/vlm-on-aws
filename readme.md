...
학습 데이터로 **VALID(Video-Audio Large Interleaved Dataset)**를 사용합니다. VALID는 약 72만 개의 Creative Commons 라이선스 YouTube 영상을 오디오·비디오·텍스트로 가공한 대규모 멀티모달 데이터셋으로, Creative Commons 기반이라 워크샵 진행과 결과물 배포에 대한 라이선스 부담이 적습니다. 또한 영상뿐 아니라 오디오까지 함께 제공되어, 화면상의 행동 인식은 물론 인물 간 대화 여부까지 판단하는 데 활용할 수 있어 본 파이프라인의 장면 분석 목적에 적합합니다.
