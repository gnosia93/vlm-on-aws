...
학습 데이터로 FineVideo를 사용합니다. FineVideo는 Hugging Face가 공개한 대규모 영상 이해용 데이터셋으로, YouTube에 Creative Commons Attribution(CC-BY) 라이선스로 공개된 약 43,000개의 실사 영상(평균 4.7분, 총 약 3,425시간, 122개 카테고리)을 YouTube-Commons 로부터 수집해 구성했습니다.
